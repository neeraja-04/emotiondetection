...
haf = Blueprint('haf', __name__,static_folder='static',template_folder='templates')
...
model.load_weights('./models/HAF.weights.h5')
...
#image processing
@haf.route('/predict', methods=['POST'])
def predict():
...
@haf.route('/predict-video', methods=['POST'])
def predict_video():
